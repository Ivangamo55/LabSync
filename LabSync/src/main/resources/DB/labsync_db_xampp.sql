...
CREATE DATABASE IF NOT EXISTS `labsync_db` CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE `labsync_db`;
...
CREATE TABLE IF NOT EXISTS `usuario` (
  ...
  `correo` varchar(75) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
