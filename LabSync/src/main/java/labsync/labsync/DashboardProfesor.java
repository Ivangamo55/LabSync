 ...
 * La sección initComponents se mantiene sincronizada con DashboardProfesor.form.
 */
public class DashboardProfesor extends javax.swing.JFrame {
    ...
    public DashboardProfesor(String nombreRecibido) {
        this(SesionUsuario.buscarProfesor(nombreRecibido));
    }

    public DashboardProfesor(SesionUsuario sesionRecibida) {
        initComponents();
    ...
    private void configurarPantalla() {
        ...
        lbVerTodas.addMouseListener(new java.awt.event.MouseAdapter() {
            @Override public void mouseClicked(java.awt.event.MouseEvent evt) {
                abrirVentana(new MisReservasProfesor(sesion));
            }
        });
        cargarResumen();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new DashboardProfesor("Profesor").setVisible(true));
    }
