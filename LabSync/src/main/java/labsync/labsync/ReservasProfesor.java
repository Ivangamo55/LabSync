 ...
 * La sección initComponents se mantiene sincronizada con ReservasProfesor.form.
 */
public class ReservasProfesor extends javax.swing.JFrame {

    private String nombreUsuario;
    private SesionUsuario sesion;

    public ReservasProfesor() {
        this("Profesor");
    }

    public ReservasProfesor(String nombreRecibido) {
        this(SesionUsuario.buscarProfesor(nombreRecibido));
    }

    public ReservasProfesor(SesionUsuario sesionRecibida) {
        initComponents();
    ...
    private void initComponents() {
        ...
        cmbGrupo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] {"Seleccionar", "A", "B", "C", "D"}));
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(ReservasProfesor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        java.awt.EventQueue.invokeLater(() -> new ReservasProfesor("Profesor").setVisible(true));
    }
