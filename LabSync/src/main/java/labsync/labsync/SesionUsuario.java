...
public final class SesionUsuario {
     ...
     * El acceso normal crea la sesión desde Login con el id ya autenticado.
     */
    public static SesionUsuario buscarProfesor(String nombre) {
        ...
        String sql = "SELECT id, nombre, CONCAT_WS(' ', nombre, apellido_p, apellido_m) nombre_completo, rol "
                + "FROM usuario WHERE nombre = ? AND rol = 'Profesor' ORDER BY id LIMIT 1";
        ...
        return new SesionUsuario(0, nombreSeguro, nombreSeguro, "Profesor");
    }
