 ...
 * La sección initComponents se mantiene sincronizada con MisReservasProfesor.form.
 */
public class MisReservasProfesor extends javax.swing.JFrame {
    ...
    public MisReservasProfesor() {
        this("Profesor");
    }

    public MisReservasProfesor(String nombreRecibido) {
        this(SesionUsuario.buscarProfesor(nombreRecibido));
    }

    public MisReservasProfesor(SesionUsuario sesionRecibida) {
        initComponents();
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(MisReservasProfesor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        java.awt.EventQueue.invokeLater(() -> new MisReservasProfesor("Profesor").setVisible(true));
    }
