package labsync.interfaz.autenticacion;
...
/** Captura, valida y guarda los datos necesarios para registrar un usuario. */
public class VentanaRegistroUsuario extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(VentanaRegistroUsuario.class.getName());
    ...
    */
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new VentanaRegistroUsuario().setVisible(true));
    }
