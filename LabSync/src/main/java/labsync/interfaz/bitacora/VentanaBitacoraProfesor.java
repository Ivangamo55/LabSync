 ...
 * La sección initComponents se mantiene sincronizada con VentanaBitacoraProfesor.form.
 */
public class VentanaBitacoraProfesor extends javax.swing.JFrame {
    ...
    public VentanaBitacoraProfesor(String nombreRecibido) {
        this(nombreRecibido, null);
    }

    public VentanaBitacoraProfesor(String nombreRecibido, Integer idReserva) {
        this(SesionUsuario.buscarProfesor(nombreRecibido), idReserva);
    }

    public VentanaBitacoraProfesor(SesionUsuario sesionRecibida) {
        this(sesionRecibida, null);
    }

    public VentanaBitacoraProfesor(SesionUsuario sesionRecibida, Integer idReserva) {
        initComponents();
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaBitacoraProfesor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        java.awt.EventQueue.invokeLater(() -> new VentanaBitacoraProfesor("Profesor").setVisible(true));
    }
