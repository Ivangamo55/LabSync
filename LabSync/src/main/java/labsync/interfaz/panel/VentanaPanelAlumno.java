...
public class VentanaPanelAlumno extends javax.swing.JFrame {
    ...
    public VentanaPanelAlumno(String nombreRecibido) {
        ...
        new ControlNotificacionesReserva(this, headerBlanco, sesion.getId(),
                sesion.getNombreCompleto(), "Estudiante", this::mostrarTodasReservas);
        iniciarActualizacionAutomatica();
        setLocationRelativeTo(null);
    }

    private record ResumenAlumno(String activas, String proxima, String reportes,
            javax.swing.table.DefaultTableModel reservas) { }

    private void iniciarActualizacionAutomatica() {
        new ActualizacionAutomatica<>(this, 7_000, this::consultarResumenAlumno, datos -> {
            lbValorReservasActivas.setText(datos.activas());
            lbValorProximaReserva.setText(datos.proxima());
            lbDescProximaReserva.setText("Sin reservas".equals(datos.proxima())
                    ? "No tienes reservas proximas" : "Siguiente fecha reservada");
            lbValorReportes.setText(datos.reportes()); tablaReservaciones.setModel(datos.reservas());
            configurarTablaReservaciones();
        });
    }
    ...
    private void cargarResumenAlumno() {
        ...
        try (con) {
            ...
            java.util.logging.Logger.getLogger(VentanaPanelAlumno.class.getName()).log(java.util.logging.Level.SEVERE, "Error al cargar el dashboard del alumno", ex);
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaPanelAlumno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        java.awt.EventQueue.invokeLater(() -> {
            new VentanaPanelAlumno("Usuario").setVisible(true);
        });
    }
