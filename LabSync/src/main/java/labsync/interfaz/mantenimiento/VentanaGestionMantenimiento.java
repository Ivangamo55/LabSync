...
/** Administra la programación, seguimiento y cierre de mantenimientos. */
public class VentanaGestionMantenimiento extends javax.swing.JFrame {
    ...
    public VentanaGestionMantenimiento(String nombreRecibido, String codigoEquipo) {
        this(nombreRecibido);
    ...
    private boolean guardarMantenimiento(Integer idMantenimiento) {
        ...
        ServicioMantenimiento.DatosMantenimiento datos = new ServicioMantenimiento.DatosMantenimiento(
        ...
        try (con) {
            ...
            try {
                new ServicioMantenimiento().guardar(con, datos, idMantenimiento);
                con.commit();
                return true;
            } catch (ServicioMantenimiento.ConflictoMantenimientoException ex) {
                con.rollback();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(() -> new VentanaGestionMantenimiento().setVisible(true));
    }
