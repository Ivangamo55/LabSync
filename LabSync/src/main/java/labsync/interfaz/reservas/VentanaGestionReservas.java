...
/** Permite al laboratorista consultar, aprobar, rechazar y exportar reservas. */
public class VentanaGestionReservas extends javax.swing.JFrame {
        ...
        try {
            ...
            if ("Aprobada".equals(nuevoEstado)) {
                ServicioDisponibilidad.ResultadoDisponibilidad disponibilidad
                        = new ServicioDisponibilidad().validarAprobacion(con, idReserva, true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new VentanaGestionReservas().setVisible(true));
    }
